	...
	<article v-if='mode === "show"'> <!--@click="!item.noEdit && emit('openTask')">-->
		<footer class="flex items-center justify-between mb-2">
			...
			<div class="flex gap-x-2 items-center">
				...
				<button v-if='!item.noEdit' @click="emit('openTask')" class="inline-flex items-center p-2 text-sm font-medium text-center text-sky-500 bg-white rounded-lg hover:bg-sky-100 focus:ring-4 focus:outline-none focus:ring-sky-50 dark:bg-sky-800 dark:hover:bg-sky-700 dark:hover:text-sky-300 dark:focus:ring-sky-600"
				type="button">
