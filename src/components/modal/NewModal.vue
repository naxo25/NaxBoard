<template>
    <div id="readUserModal" tabindex="-1" aria-hidden="" class="fixed top-0 left-0 right-0 z-50 grid place-content-center  w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        <div class="relative w-full h-full max-w-3xl p-4 md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                    ...
                    <div>
                        <button @click='emit("changeShow")' type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readUserModal">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <dl>
                        ...
                        <input v-model="item.name" id='name' required placeholder='Escribe un título para la tarea' class="text-sm font-semibold text-gray-900 mb-4 dark:text-white border-gray-200 text-gray-900 bg-transparent rounded-lg block w-full dark:border-gray-400 dark:placeholder-gray-400 outline-none">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        <button @click='addTask(item, mode), emit("changeShow")' type="button" class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
