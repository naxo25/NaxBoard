<template>
	<div class="p-4 rounded-lg shadow-sm">
		...
		<div data-popover="" id="popover-description" role="tooltip" class="absolute z-10 invisible inline-block text-sm font-light text-gray-500 transition-opacity duration-300  border border-gray-200 rounded-lg shadow-sm opacity-0 w-72  dark:border-gray-600 dark:text-gray-400" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-486px, 105px);" data-popper-placement="bottom-end">
		...
		<div class="flex items-center justify-between pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
			<div>
				...
				<!-- Dropdown menu -->
				<div class="z-50 my-4 text-base list-none  divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 hidden" id="stats-dropdown" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(115px, 725px);" data-popper-placement="bottom">
