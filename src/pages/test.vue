  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 xl:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">Spaces</h3>
              <ul role="list" class="my-6 lg:mb-0 space-y-4">
                  <li v-for="item in Store.spaces" @click="getSpace(item.identifier)" class="flex space-x-2.5">
                      <!-- Icon -->
                      ...
                      <span class="leading-tight text-gray-500 dark:text-gray-400">{{ item.identifier }}</span>
                  </li>
              </ul>
          </div>
          ...
          <div>
          	...
          	<h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">Tasks</h3>
          	<ul role="list" class="my-6 lg:mb-0 space-y-4">
            	<li v-for="item, pos in Store.tasks" class="flex space-x-2.5" @click="getSubTasks(pos);">
            		<!-- Icon -->
            		...
            		<span class="leading-tight text-gray-500 dark:text-gray-400">{{ item.name }}</span>
            	</li>
            </ul>
          </div>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">SubTasks</h3>
              <ul role="list" class="my-6 lg:mb-0 space-y-4">
              	<li @click='showModal(item)' v-for="item in Store.tasks[Store.TaskSelectPos]?.subTasks" class="flex space-x-2.5">
              		<!-- Icon -->
...
<div class="flex justify-center m-5">
    <button id="readUserButton" @click="modal=!modal" data-modal-target="readUserModal" data-modal-toggle="readUserModal" class="block text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">
    Read user
    </button>
</div>

<!-- Main modal -->
<div id="readUserModal" v-if='modal' tabindex="-1" aria-hidden="" class="fixed top-0 left-0 right-0 z-50 grid place-content-center  w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
    <div class="relative w-full h-full max-w-3xl p-4 md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                    ...
                    <div>
                        <button @click='modal=false' type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readUserModal">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <dl>
                        ...
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Clase Lunes y Miércoles</dd>
...
<!-- Main modal -->
<div id="readUserModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 grid place-content-center w-full md:inset-0 h-modal md:h-full">
