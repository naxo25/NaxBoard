					...
					<ul class="pb-2 space-y-2">
						...
						<li>
							...
							<ul id="dropdown-layouts" class="p-2 pl-4 space-y-2">
								<li class='flex items-center' v-for="item in Store.spaces">
									<img :src="item.logo || 'https://nacholabraweb.000webhostapp.com/ico.png'" class="w-6 h-6">
									<a href="https://themesberg.github.io/flowbite-astro-admin-dashboard/layouts/stacked" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-4 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
										{{ item.identifier }}
									</a>
								</li>
							</ul>
